...
function getCitation(targetElement, copiedText) {
    ...
    */
    ...
    const unionText = regexService.unionStrings(copiedText, sectionText);
    console.log(`unionText: \n${JSON.stringify(unionText)}`);
    const provision = getProvisions_1.getProvisions(unionText, fullText);
...
class RegexService {
    ...
    unionStrings(str1, str2) {
        ...
        const str2WithoutOverlap = str2.substring(endIndexOfOverlapInStr2);

...
/***/ "./src/content-script/sso.agc.gov.sg.ts":
/*!**********************************************!*\
  !*** ./src/content-script/sso.agc.gov.sg.ts ***!
  \**********************************************/
...
var dom_service_1 = __webpack_require__(/*! ../services/dom-service */ "./src/services/dom-service.ts");
var provision_service_1 = __webpack_require__(/*! ../services/provision-service */ "./src/services/provision-service.ts");
var regex_service_1 = __webpack_require__(/*! ../services/regex-service */ "./src/services/regex-service.ts");
function getProvisions(targetElement) {
    ...
    try {
        for (var provisions_1 = __values(provisions), provisions_1_1 = provisions_1.next(); !provisions_1_1.done; provisions_1_1 = provisions_1.next()) {
            ...
            if (regexService.isRoman(prevProv) && regexService.isAlpha(text) && text !== '(i)')
                provResult.unshift(text);
            // prevProvResult isAlpha, add the next prov that is a number
            // e.g. (a), next prov should be 15
            if (regexService.isAlpha(prevProv) && regexService.isBracketedNumber(text))
                provResult.unshift(text);
...
var RegexService = /** @class */ (function () {
    ...
    // E.g. (a)
    RegexService.prototype.isAlpha = function (str) {
        return /\([A-Z]+\)/i.test(str);
    };
    // E.g. (i), (iv)
    RegexService.prototype.isRoman = function (str) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var sso_agc_gov_sg_1 = __webpack_require__(/*! ./sso.agc.gov.sg */ "./src/content-script/sso.agc.gov.sg.ts");
document.addEventListener('copy', function (event) {
    ...
    if (!copiedText)
        return;
    var provision = sso_agc_gov_sg_1.getProvisions(targetElement);

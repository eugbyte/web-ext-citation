...
function getChapter() {
    var regextService = new regex_service_1.RegexService();
    var chapterElement = document.querySelector(".front");
    var parentText = chapterElement.innerText;
...
var regex_service_1 = __webpack_require__(/*! src/services/regex-service */ "./src/services/regex-service.ts");
function getProvisions(targetElement) {
    var e_1, _a;
    ...
    var parentElement = domService.traverseUpToElement(targetElement, 'DIV');
    var parentFullText = parentElement.innerText;
    // E.g. 15.—(1) or 15. or (a)
    var regex = /\d+\w?\.—\(\d+\)|\d+\.|\n\(\w+\)/g;
    ...
    var startIndex = domService.getStartIndexOfCopiedText(targetElement.innerText, parentFullText);
    var endIndex = startIndex + targetElement.innerText.length;
...
function getCitation(targetElement) {
    ...
    */
    ...
    var provision = getProvisions_1.getProvisions(cloneTarget);
...
var DOMService = /** @class */ (function () {
    ...
    DOMService.prototype.getStartIndexOfCopiedText = function (childFullText, parentFullText) {

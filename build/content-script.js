...
function getCitation(targetElement) {
    ...
    */
    ...
    var table = cloneTarget.querySelector("table");
    if (table != null)
...
var DOMService = /** @class */ (function () {
    ...
    DOMService.prototype.copyNodeWithParentRef = function (targetElement) {
...
var RegexService = /** @class */ (function () {
    ...
    RegexService.prototype.replaceMultiLineBreakWithSingleLineBreak = function (str) {
        return str.replace(/\n+/g, "\n");
    };
...
var getChapter_1 = __webpack_require__(/*! ./sso.agc.gov.sg/getChapter */ "./src/content-script/sso.agc.gov.sg/getChapter.ts");
document.addEventListener('copy', function (event) {
    ...
    if (!copiedText)
        return;
    var provision = sso_agc_gov_sg_1.getCitation(targetElement);
    console.log("result:", provision);
    getChapter_1.getChapter();

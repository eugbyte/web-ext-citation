 ...
 */
  ...
  \********************************************/
    /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      ...
      const __values = (this && this.__values) || function (o) {
        const s = typeof Symbol === 'function' && Symbol.iterator; const m = s && o[s]; let i = 0
      ...
      const ProvisionComponent = /** @class */ (function () {
      ...
      function processElement (targetElement) {
        let e_1, _a
        const parentElement = traverseUpToElement(targetElement, 'DIV')
        const parentFullText = parentElement.innerText
        console.log(parentFullText)
        // E.g. 15.—(1) or (a)
        const regex = /\d+\w?\.—\(\d+\)|\n\(\w+\)/g
        const matches = findMatches(regex, parentFullText)
        let provisions = matches.map(function (m) { let _a; return new ProvisionComponent((_a = m.index) !== null && _a !== void 0 ? _a : -1, m[0]) })
        // Need to seperate 15.—(1) into 15. and (1)
        const originalFirstComponent = provisions.shift()
        const _b = __read(splitFirstProvisionComponent(originalFirstComponent), 2); const newFirstComponent = _b[0]; const newSecondComponent = _b[1]
        ...
        const startIndex = getStartIndexOfCopiedText(targetElement, parentFullText)
        const endIndex = startIndex + targetElement.innerText.length
        ...
        try {
          for (var provisions_1 = __values(provisions), provisions_1_1 = provisions_1.next(); !provisions_1_1.done; provisions_1_1 = provisions_1.next()) {
            const prov = provisions_1_1.value
            ...
            const isFirstProvComponent = isNumber(prevProv)
      ...
      function splitFirstProvisionComponent (originalFirstComponent) {
        const _a = __read(originalFirstComponent.text.split('.—'), 2); const firstProvText = _a[0]; const secondProvText = _a[1]
      ...
      function getStartIndexOfCopiedText (targetElement, parentFullText) {
        const childFullText = targetElement.innerText
      ...
      function findMatches (regex, text) {
        const matches = __spreadArray([], __read(text.matchAll(regex)))
        return matches
      }
      /***/ }
  ...
  \**********************************************/
    ...
    Object.defineProperty(exports, '__esModule', ({ value: true }))
    const traverse_dom_1 = __webpack_require__(/*! ./traverse-dom */ './src/content-script/traverse-dom.ts')

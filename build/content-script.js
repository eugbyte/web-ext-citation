...
function getProvisions(targetElement) {
    ...
    var startIndex = domService.getStartIndexOfCopiedText(targetElement, parentFullText);
...
function getCitation(targetElement) {
    ...
    return getProvisions_1.getProvisions(targetElement);
}
...
var DOMService = /** @class */ (function () {
    ...
    DOMService.prototype.getStartIndexOfCopiedText = function (targetElement, parentFullText) {
        var childFullText = targetElement.innerText;
